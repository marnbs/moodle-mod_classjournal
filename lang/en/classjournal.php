...
$string['decimalpoints_help'] = 'Number of digits shown after the decimal separator for numeric lesson grades, maximum grades, and journal totals. This changes display only; stored grades and calculations keep their full precision.';
