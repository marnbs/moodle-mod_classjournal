...
/**
 * The mod_classjournal course module viewed event.
 *
...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'classjournal';
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/classjournal/view.php', ['id' => $this->contextinstanceid]);
    }
}
