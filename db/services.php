...
$functions = [
    ...
    'classjournal_update_lesson' => [
        'classname' => 'mod_classjournal\external\update_lesson',
        'methodname' => 'execute',
        'description' => 'Update an existing lesson in a class journal.',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'mod/classjournal:manage',
    ],
    'classjournal_delete_lesson' => [
        'classname' => 'mod_classjournal\external\delete_lesson',
        'methodname' => 'execute',
        'description' => 'Delete a lesson from a class journal.',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'mod/classjournal:manage',
    ],
